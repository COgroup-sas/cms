            ...
            <div class="col-12">
              ...
              <div class="card login opacity-80" data-background-color="white">
                ...
                <div class="card-body px-lg-4 pt-0">
                  ...
                  <!-- Form -->
                  <form class="text-center needs-validation text-color" data-color="dark" novalidate method="POST" action="{{ route('register') }}">
                    @csrf
                    ...
                    <!-- Name -->
                    <div class="md-form">
                        <input required name="name" type="text" class="form-control" value="{{ old('name') }}" autofocus autocomplete="off" />
                        <label for="name">{{ __('moduleusers.name') }}</label>
                        @if ($errors->has('name'))
                    ...
                    <!-- Lastname -->
                    <div class="md-form">
                        <input required name="lastname" type="text" class="form-control" value="{{ old('lastname') }}" autocomplete="off" />
                        <label for="name">{{ __('moduleusers.lastname') }}</label>
                    ...
                    <!-- Email -->
                    <div class="md-form">
                      <input type="email" id="LoginFormEmail" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                    ...
                    <!-- Sign in button -->
                    <button class="btn btn-theme btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit">{{ __('cms.register') }}</button>
                  ...
                  <div class="d-flex justify-content-around">
                    <div>
                        @if (Route::has('cogroupcms.home'))
                            <!-- Login -->
                            <a href="{{ route('cogroupcms.home') }}">{{ __('cms.login') }}</a>
                        @endif
                    </div>
                  </div>
