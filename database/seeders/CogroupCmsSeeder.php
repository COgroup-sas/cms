...
class CogroupCmsSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    DB::table('roles')->insert([
      ...
      [
        'rolname' => 'Usuario',
        'description' => 'Rol para Usuarios. Este es el rol por defecto'
      ]
    ]);
    ...
    DB::table('modules')->insert([
      ...
      [ 
        ...
        'active' => 'Y', 'url' => 'cogroupcms.settings.home', 'icon' => 'fa fa-cogs', 'parent' => '0', 'order' => '0', 'inmenu' => 'Y', 
        'permissions' => 'view,update'
      ],
      [ 
        'id' => '2', 'moduleslug' => 'roles', 'modulename' => 'Roles', 'description' => 'Módulo de Administración de Roles del sistema', 
        'active' => 'Y', 'url' => 'cogroupcms.roles.home', 'icon' => 'fa fa-user-plus', 'parent' => '0', 'order' => '1', 'inmenu' => 'Y', 
      ...
      [ 'id' => '4', 'moduleslug' => 'users', 'modulename' => 'Usuarios', 'description' => 'Módulo de Administración de usuarios del sistema', 
        'active' => 'Y', 'url' => 'cogroupcms.users.home', 'icon' => 'fa fa-users', 'parent' => '0', 'order' => '3', 'inmenu' => 'Y', 
        'permissions' => 'view,create,update'
      ]
    ]);
