...
class RolesController extends CmsController {
  ...
  public function index(Request $request) {
    ...
    parent::registerScripts(array('src' => url('themecms/js/pages/roles/roles.js')));

    $breadcrumb = array(trans('cogroupcms.cms.home'), trans('cogroupcms.moduleroles.title'));
  ...
  public function add(Request $request) {
    ...
    $breadcrumb = array(trans('cogroupcms.cms.home'), trans('cogroupcms.moduleroles.title'), trans('cogroupcms.moduleroles.add'));

    parent::registerScripts(array('src' => url('themecms/js/pages/roles/rolesregister.js')));
  ...
  public function addpost(Request $request) {
    ...
    $validator = Validator::make($request->all(), [
        'rolname' => 'required|max:255|alpha_spaces',
    ...
    return redirect(route('roleshome'));
  }
  ...
  public function permissions(Request $request) {
    ...
    $breadcrumb = array(trans('cogroupcms.cms.home'), trans('cogroupcms.moduleroles.title'), trans('cogroupcms.moduleroles.permissions'));
    ...
    parent::registerScripts(array('src' => url('themecms/js/pages/roles/permissions.js')));
  ...
  public function edit(Request $request) {
    ...
    $breadcrumb = array(trans('cogroupcms.cms.home'), trans('cogroupcms.moduleroles.title'), trans('cogroupcms.moduleroles.edit'));
