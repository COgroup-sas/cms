...
class DashboardController extends CmsController
{
    ...
    public function index()
    {
        ...
        return view('cogroupcms::home')->with(
          array(
            'user' => Auth::user(),
  ...
  public function settings(Request $request) {
    ...
    parent::registerScripts(array('src' => url('themecms/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')));
